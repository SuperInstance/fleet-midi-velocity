# Student Guide: fleet-midi-velocity

_Learn how the velocity agent works and how to use it._

---

## What You'll Learn

1. What the velocity musical concept is
2. How ternary decomposition applies to velocity
...
```bash
curl -s http://localhost:2171/health | python3 -m json.tool
```
...
```bash
curl -s -X POST http://localhost:2171/agent \
